...
export const getVote = async (
  ...
  try {
    const response: AxiosResponse<VoteGetType> = await axios.get(
      `${API_URL}/${API_REST}`,
      {
        headers: {
...
export const getVoteDetail = async (Token: string, API_REST: string) => {
  try {
    const response: AxiosResponse<VoteDetailType> = await axios.get(
      `${API_URL}/${API_REST}`,
      {
        headers: {
          Authorization: `Bearer ${Token}`, // Use response data here
...
export const getVoteResult = async (Token: string, API_REST: string) => {
  try {
    const response: AxiosResponse<VoteResultType> = await axios.get(
      `${API_URL}/${API_REST}`,
      {
        headers: {
          Authorization: `Bearer ${Token}`, // Use response data here
...
export const CreateVote = async (
  ...
  try {
    const response: AxiosResponse<VoteGetType> = await axios.post(
      `${API_URL}/${API_REST}`,
      {
        ...data,
      },
