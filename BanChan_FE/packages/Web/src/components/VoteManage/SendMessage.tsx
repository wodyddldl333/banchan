...
interface MultiSelectDropdownProps {
  ...
  const MultiSelectDropdown: React.FC<MultiSelectDropdownProps> = ({ options, fieldName, selectedOptions, setSelectedOptions }) => {
...
{/* 동호수 선택 input */}
            <MultiSelectDropdown options={options} fieldName={'baby'} selectedOptions={selectedOptions} setSelectedOptions={setSelectedOptions} />
            <div>
                <input
                name="unit"
                type="text"
