  ...
  return (
    <div className="flex justify-center items-center h-screen">
      <form onSubmit={handleSubmit} className="bg-white p-6 rounded-lg shadow-md w-96">
        ...
        <div className="mb-4">
          <label htmlFor="dong" className="block text-gray-700">동</label>
          <input
            type="text"
            id="dong"
            value={dong}
        ...
        <div className="mb-4">
          <label htmlFor="ho" className="block text-gray-700">호</label>
          <input
            type="text"
            id="ho"
            value={ho}
        ...
        <button type="submit" className="w-full bg-blue-500 text-white py-2 rounded-lg">저장</button>
      </form>
    </div>
  );
};
