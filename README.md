...
![로그인 및 메인페이지](exec/resources/main.png)

**_마이페이지_**

![마이페이지](exec/resources/mypage.png)

**_투표페이지_**

![투표페이지](exec/resources/vote.png)

**_화상회의 페이지_**

![화상회의](exec/resources/conf.png)

**_공지사항_**

![공지사항](exec/resources/notice.png)

### 와이어프레임(웹-관리자)

**_관리자 로그인 페이지_**

![관리자 로그인](exec/resources/admin_login.png)

**_기능 관리 페이지_**

![관리페이지](exec/resources/web.png)
